...
const banner_schema_1 = require("./scehma/banner.schema");
let BannerService = class BannerService {
    ...
    async findAllByCategory(categoryName) {
        ...
        if (data.length === 0) {
            throw new common_1.NotFoundException('No data found for this category');
        }
        return data;
    }
    async update(permalink, updateData) {
